...
function Audio() {
    ...
    function handleClick() {
        ...
        audioRef.current.volume =
            newVolume === 1 ? 0.25 : newVolume === 2 ? 0.66 : newVolume === 3 ? 1 : 0;
    }
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <path
                        strokeOpacity={volume === 0 ? 1 : 0}
                        d="M17.5 7.5L26.5 16.5M26.5 7.5L17.5 16.5"
                    />
                    <path
                        strokeOpacity={volume >= 1 ? 1 : 0}
                        d="M17 9C19 11 19 13 17 15"
                    />
                    <path
                        strokeOpacity={volume >= 2 ? 1 : 0}
                        d="M20 7C23.5 10.5 23.5 13.5 20 17"
                    />
                    <path
                        strokeOpacity={volume >= 3 ? 1 : 0}
                        d="M23 5C28 10 28 14 23 19"
                    />
                </g>
            </svg>
            <audio
